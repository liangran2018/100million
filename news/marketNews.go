...
func init() {
	...
	news[goods.Phone] = []newsIndex{PhoneMore, PhoneLess}
	...
	news[goods.BTC] = []newsIndex{BtcMore, BtcLess}
	newsStr[BtcMore] = newsFeature{intro:"数字加密货币时代到来，比特币价格疯狂上涨！", style:styleGood, promin:90, promax:100}
	newsStr[BagLess] = newsFeature{intro:"遭遇多国监管高压，比特币价格暴跌！", style:styleBad, promin:0, promax:45}

	news[goods.Gold] = []newsIndex{GoldMore, GoldLess}
	...
	news[goods.Car] = []newsIndex{CarMore, CarLess}
	...
	news[goods.Wine] = []newsIndex{WineMore, WineLess}
	...
	news[goods.Domain] = []newsIndex{DomainMore, DomainLess}
	...
	news[goods.Stone] = []newsIndex{StoneMore, StoneLess}
	...
	news[goods.DogFood] = []newsIndex{DogFoodMore, DogFoodLess}
	...
	news[goods.Bag] = []newsIndex{BagMore, BagLess}
